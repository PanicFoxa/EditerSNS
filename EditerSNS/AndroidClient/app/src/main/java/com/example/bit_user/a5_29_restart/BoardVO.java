...
public class BoardVO {
    ...
    public BoardVO(int read_num, int write_user, float read_lat, float read_lont, int share_whether, Bitmap bg_img, String txt_content, String txt_color, String txt_font, String txt_weight, Float txt_size, int txt_orit, String txt_location, String txt_sort, ArrayList<BoardSketchVO> board_sketch) {
        this.read_num = read_num;
        this.write_user = write_user;
        this.read_lat = read_lat;
        this.read_lont = read_lont;
        this.share_whether = share_whether;
        this.bg_img = bg_img;
        ...
        this.txt_orit = txt_orit;
        this.txt_location = txt_location;
        this.txt_sort = txt_sort;
        this.board_sketch = board_sketch;
    }
    ...
    public Bitmap getBg_img() { return bg_img; }
    public void setBg_img(Bitmap bg_img) { this.bg_img = bg_img; }
